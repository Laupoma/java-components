...
public class UpdateSystemPerformanceResourceHandler extends CoapResource
{
	...
	{
		context.accept();
		context.respond(ResponseCode.CONTENT, "GET not fully implemented.");
	}
	...
	{
		context.accept();
		context.respond(ResponseCode.CREATED, "POST not fully implemented.");
	}
	...
	{
		context.accept();
		context.respond(ResponseCode.DELETED, "DELETE not fully implemented.");
	}
}
